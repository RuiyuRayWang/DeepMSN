...
def clean_bed_entries(regions_and_topics, genome_fasta, valid_bases=None):
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Preprocess genomic data with train/val/test split and clean seq's containing invalid bases.")
    ...
    valid_bases = config_ds.get('valid_bases', {'A', 'T', 'C', 'G'})
    ...
    datasets = [
        ...
        (train_regions, train_fn, "training"),
